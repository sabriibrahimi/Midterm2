package HashMapsExc.Birthdayss;
...
public class Birthdays {
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        for(int i=0;i<N;i++){
            ...
            if(birthdays.search(split[1]) == null) {
                birthdays.insert(split[1], 1);
            } else {
                SLLNode<MapEntry<String, Integer>> br  = birthdays.search(split[1]);
                birthdays.insert(split[1], br.element.value+1);
            }
        }
